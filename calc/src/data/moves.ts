...
const RBY: {[name: string]: MoveData} = {
  ...
  'Double Kick': {bp: 40, type: 'Fighting', multihit: 2},
  ...
  'Razor Wind': {bp: 120, type: 'Flying', recoil: [1, 3]},
  ...
  Flash: {bp: 70, category: 'Special', type: 'Electric'},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  Overheat: {bp: 130, type: 'Fire', recoil: [1, 3]},
  ...
  'Blaze Kick': {bp: 40, type: 'Fire', multihit: 2},
  ...
  Superpower: {bp: 120, type: 'Fighting', recoil: [1, 3]},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Draco Meteor': {bp: 130, type: 'Dragon', recoil: [1, 3]},
  'Dragon Pulse': {bp: 90, type: 'Dragon', category: 'Special'},
  'Dragon Rush': {bp: 110, type: 'Dragon', recoil: [1, 3]},
  ...
  'Leaf Storm': {bp: 130, type: 'Grass', category: 'Special', recoil: [1, 3]},
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Fleur Cannon': {bp: 130, type: 'Fairy', recoil: [1, 3]},
...
const SS_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Steel Beam': {bp: 130, type: 'Steel', recoil: [1, 3]},
  'Steel Roller': {
    bp: 130,
    type: 'Steel',
    category: 'Physical',
